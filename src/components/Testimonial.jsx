...
const Testimonial = () => {
  return (
   ...
   <Container>
            <Row>
<Col md={12} className="testimonial-head"> 
<div className='testimonial-background'>
    <h1 className='testimonial-heading  text-center'>What our client Say</h1>
</div>
</Col>
<Row>
  <Col md={6}>
  ...
  <Col md={6}>
  <Container><img src='images/testimonialgroup.webp' className='nearby-side'></img></Container>
  </Col>
</Row>
            </Row>
